...
public class UpdatesTab extends ViewProjectScreen.TabScreen {
    ...
    private void showUpdateForm(){
        ...
        fadeIn.setOnFinished(evt -> {
            ...
            FadeTransition fade = new FadeTransition(Duration.millis(200), updateForm.contentView);
            fade.setToValue(1.0);
            fade.setInterpolator(new ExponentialInterpolator(EasingMode.EASE_OUT));
    ...
    private class UpdateForm {
        ...
        class AttachmentNode extends VBox {
            ImageView iv;
            Label fileName;
