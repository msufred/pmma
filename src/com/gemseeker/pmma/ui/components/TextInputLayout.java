...
public class TextInputLayout extends StackPane implements ChangeListener<Boolean> {
    ...
    private static final PseudoClass NOT_ANIMATED = PseudoClass.getPseudoClass("not-animated");
    private static final PseudoClass BAR_PLACED = PseudoClass.getPseudoClass("bar-placed");
    private static final Duration ANIM_DURATION = new Duration(200);
